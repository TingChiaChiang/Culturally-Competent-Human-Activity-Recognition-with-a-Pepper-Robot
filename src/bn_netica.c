...
int main (void)
{
	...
	*/
	...
	FILE *fp_csv, *fp_txt;
	const char *file_name_csv ="../netica_output/Netica_output_E_Varied.csv";
	const char *file_name_txt ="../netica_output/Netica_output_E_Varied.txt";
	...
	void WriteResult(char *file_path, char *actual_activity,char *default_culture,int default_time) {
	...
	char *file_path_e_cook = "../api_result/Varied_images_result/English/API_result_e_cook_real.py";
	char *file_path_e_eat = "../api_result/Varied_images_result/English/API_result_e_eat_real.py";
	char *file_path_e_read = "../api_result/Varied_images_result/English/API_result_e_read_real.py";
	char *file_path_e_shower = "../api_result/Varied_images_result/English/API_result_e_shower_real.py";
	char *file_path_e_sleep = "../api_result/Varied_images_result/English/API_result_e_sleep_real.py";
	char *english_culture = "English";


	                           //actual actitivy  default culture  default time
							                                     // 0-23
	WriteResult(file_path_e_cook, "Cooking", english_culture, 18);
	WriteResult(file_path_e_eat,  "Eating",  english_culture, 13);
	WriteResult(file_path_e_read, "Reading", english_culture, 21);
	WriteResult(file_path_e_shower, "Showering", english_culture, 9);
	WriteResult(file_path_e_sleep, "Sleeping", english_culture, 0);


	// // Indian culture
	// // vision API result path (should be the same path where output of pepper motion module is saved)
	// char *file_path_i_cook = "../api_result/Varied_images_result/Indian/API_result_i_cook_real.py";
	// char *file_path_i_eat = "../api_result/Varied_images_result/Indian/API_result_i_eat_real.py";
	// char *file_path_i_read = "../api_result/Varied_images_result/Indian/API_result_i_read_real.py";
	// char *file_path_i_pray = "../api_result/Varied_images_result/Indian/API_result_i_puja_pray_real.py";
	// char *file_path_i_sleep = "../api_result/Varied_images_result/Indian/API_result_i_sleep_real.py";
	// char *indian_culture = "Indian";
	//
	//
	//                            //actual actitivy  default culture  default time
	// 						                                     // 0-23
	// WriteResult(file_path_i_cook, "Cooking", indian_culture, 20);
	// WriteResult(file_path_i_eat,  "Eating",  indian_culture, 13);
	// WriteResult(file_path_i_read, "Reading", indian_culture, 22);
	// WriteResult(file_path_i_pray, "Praying", indian_culture, 9);
	// WriteResult(file_path_i_sleep, "Sleeping", indian_culture, 0);
	//
	//
	//
	// // Japanese culture
	// // vision API result path (should be the same path where output of pepper motion module is saved)
	// char *file_path_j_cook = "../api_result/Varied_images_result/Japanese/API_result_j_cook_real.py";
	// char *file_path_j_eat = "../api_result/Varied_images_result/Japanese/API_result_j_eat_real.py";
	// char *file_path_j_read = "../api_result/Varied_images_result/Japanese/API_result_j_read_real.py";
	// char *file_path_j_sleep = "../api_result/Varied_images_result/Japanese/API_result_j_sleep_real.py";
	// char *japanese_culture = "Japanese";
	//
	//
	//                            //actual actitivy  default culture  default time
	// 						                                     // 0-23
	// WriteResult(file_path_j_cook, "Cooking", japanese_culture, 18);
	// WriteResult(file_path_j_eat,  "Eating",  japanese_culture, 12);
	// WriteResult(file_path_j_read, "Reading", japanese_culture, 21);
	// WriteResult(file_path_j_sleep, "Sleeping", japanese_culture, 0);
	...
	printf("!!!! The results have been printed in Netica_output.csv and Netica_output.txt (in the folder called netica_output ) !!!!!\n\n");
	// getchar();
	return (res < 0) ? -1 : 0;
